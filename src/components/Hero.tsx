    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-5 text-center lg:px-8">
        <span className="inline-flex items-center gap-2 rounded-full border border-sky-400/30 bg-sky-400/10 px-4 py-1.5 text-xs font-medium text-sky-300">
          ...
          ⭐ Autoryzacja Mitsubishi Electric • Gree • Haier • Rotenso • Kaisai • AUX • Sevra
        </span>
        ...
        <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-white/65 sm:text-lg">
          CzasKlimy.pl to wyspecjalizowany dział klimatyzacji firmy RoboGaz
          Sp. z o.o. – instalujemy systemy grzewcze i chłodnicze w Warszawie i
          okolicach od 20 lat.
        </p>
